...
### Option Considered: `NIGHTCAP_UNSAFE_CEF_COMPAT=1` Flag
...
**Cons:**
- ❌ Defeats purpose of frankea/Nightcap#41 (fix launcher issues)
...
**Idea:** `NIGHTCAP_UNSAFE_CEF_COMPAT=1` required  
...
1. **macOS App Sandbox**
   ...
   - Limit Nightcap.app's own permissions
