...
// MARK: - NightcapWineInstaller Path Tests

final class NightcapWineInstallerPathTests: XCTestCase {
    func testLibraryFolderPath() {
        let path = NightcapWineInstaller.libraryFolder.path
    ...
    func testBinFolderPath() {
        let path = NightcapWineInstaller.binFolder.path
