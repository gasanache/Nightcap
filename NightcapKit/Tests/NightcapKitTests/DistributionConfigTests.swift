...
final class DistributionConfigTests: XCTestCase {
    ...
    func testBaseURL() {
        XCTAssertEqual(DistributionConfig.releasesBaseURL, "https://github.com/gasanache/Nightcap/releases/download")
    }
    ...
    func testReleasesBaseURL() {
        let expectedURL = "https://github.com/gasanache/Nightcap/releases/download"
    ...
    func testLibrariesURLWithStandardVersion() {
        ...
        let expectedURL = "https://github.com/gasanache/Nightcap/releases/download/v2.5.0/Libraries.tar.gz"
    ...
    func testLibrariesURLWithSingleDigitVersion() {
        let version = "1.0.0"
        let url = DistributionConfig.librariesURL(version: version)
        let expectedURL = "https://github.com/gasanache/Nightcap/releases/download/v1.0.0/Libraries.tar.gz"
    ...
    func testLibrariesURLWithMultiDigitVersion() {
        ...
        let url = DistributionConfig.librariesURL(version: version)
        let expectedURL = "https://github.com/gasanache/Nightcap/releases/download/v10.20.30/Libraries.tar.gz"
    ...
    func testLibrariesURLFormatRegex() {
        ...
        let pattern = "^https://github\\.com/gasanache/Nightcap/releases/download/"
    ...
    func testNightcapWineInstallerUsesDistributionConfig() {
        // Verify that NightcapWineInstaller uses DistributionConfig for version checks
        ...
        XCTAssertNotNil(
            expectedURLObject,
            "DistributionConfig should provide a valid URL for NightcapWineInstaller"
        )
        XCTAssertEqual(
            expectedURL,
    ...
    /// Tests the complete version-to-URL workflow as used in NightcapWineDownloadView.fetchVersionAndDownload()
    func testCompleteVersionFetchToDownloadURLWorkflow() throws {
        ...
        let versionInfo = try decoder.decode(NightcapWineVersion.self, from: data)
    ...
    func testInvalidVersionPlistHandling() {
        ...
        do {
            ...
            let decoder = PropertyListDecoder()
            _ = try decoder.decode(NightcapWineVersion.self, from: data)
    ...
    func testURLConstructionEdgeCases() {
        ...
        let expectedZeroURL = "https://github.com/gasanache/Nightcap/releases/download/v0.0.0/Libraries.tar.gz"
        ...
        let expectedLargeURL = "https://github.com/gasanache/Nightcap/releases/download/v999.999.999/Libraries.tar.gz"
    ...
    func testHTTPStatusCodeErrorMessages() {
        // These test cases document the HTTP error handling in NightcapWineDownloadView
    ...
    func testAllURLsAreValidForURLSession() {
        ...
        XCTAssertEqual(versionURL?.host, "github.com")
