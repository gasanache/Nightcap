...
Understand how NightcapKit components work together to manage Wine bottles and Windows applications.

## Overview

NightcapKit is organized into several logical layers, each responsible for a specific aspect of Wine management on macOS.

```
┌─────────────────────────────────────────────────────────────┐
│                    Application Layer                         │
│                 (Nightcap.app, NightcapCmd)                      │
├─────────────────────────────────────────────────────────────┤
│                      NightcapKit                               │
│  ┌─────────────┐  ┌──────────────┐  ┌───────────────────┐  │
│  │   Bottle    │  │    Wine      │  │ NightcapWineInstaller│  │
...
NightcapKit includes a complete Windows PE (Portable Executable) file parser:
...
NightcapKit uses Swift's actor isolation for thread safety:
...
When running a program, NightcapKit builds a complete environment:
...
NightcapKit is extended through several mechanisms:
