...
struct ProgramView: View {
    ...
    var body: some View {
        ...
        .formStyle(.grouped)
        .animation(.nightcapDefault, value: configSectionExpanded)
        .animation(.nightcapDefault, value: envArgsSectionExpanded)
        .animation(.nightcapDefault, value: overridesSectionExpanded)
        .animation(.nightcapDefault, value: consoleRunsSectionExpanded)
        .task {
