...
/// related to frankea/Nightcap#41. It generates detailed reports of bottle configuration,
...
enum LauncherDiagnostics {
    ...
    static func generateDiagnosticReport(for bottle: Bottle) async -> String {
        var report = """
        ═══════════════════════════════════════════════════════
        Nightcap Launcher Diagnostics Report
    ...
    ///   - filename: Optional filename (default: "nightcap-diagnostics-<timestamp>.txt")
    ...
    static func exportReport(_ report: String, filename: String? = nil) throws -> URL {
        ...
        let finalFilename = filename ?? "nightcap-diagnostics-\(timestamp).txt"
